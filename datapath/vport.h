...
#ifdef _SR_
int ovs_vport_send_segments(struct vport *, struct sk_buff *, struct ipv6_segments *);
#endif
...
#ifdef _SR_
	//BN
	int (*send_with_segments)(struct vport *, struct sk_buff *, struct ipv6_segments *);
#endif
...
extern const struct vport_ops ovs_srv6_vport_ops;	// declare ovs_srv6_vport_ops
