...
<img src="img/tutorial_software.png" width="600">
...
<img src="img/tutorial_scenario_1.png" width="500">
...
<img src="img/tutorial_scenario_2.png" width="500">
...
<img src="img/tutorial_topology.png" width="500">
...
<img src="img/tutorial_profile.png" width="600">
...
<img src="img/tutorial_webportal.png" width="600">
...
To test bandwidth, you can use `iperf` IPv6, eg:

        On node 6, run: iperf -V -s
        On node 0, run: iperf -V -c <node 6's IPv6 address> -M 500 -t 20s
...
After around 10s, refresh the web-portal. You'll see that the network topology is now changed:
   <img src="img/tutorial_linkdown.png" width="600">
